...
import {addToCart, deleteFromCart, removeFromCart} from "../redux-action/cartAction";
      ...
      <h1 className='text-5xl font-semibold'>Giỏ hàng</h1>
        ...
        <div className='py-3 grid grid-cols-12 gap-4' >
            <div className='col-span-9 pr-5'>
                <p className='font-semibold py-3'>2 khóa học trong giỏ hàng</p>
                {
            ...
            <div className='col-span-3 pt-3'>
                ...
                <button className='bg-[#5E54F3] text-white font-semibold py-2 hover:opacity-80 cursor-pointer mt-5 w-full'> Thanh toán </button>
        ...
        <div className="grid grid-cols-12 my-1 border border-gray-800 cursor-pointer">
            ...
            <div className="col-span-3 relative flex justify-center items-center">
                ...
                <div className='text-white flex gap-2'>
                    ...
                    <input type="text" value={course.quantity} className='w-10 text-center text-black' />
